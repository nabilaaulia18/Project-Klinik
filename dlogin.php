...
<br><br><br><br>
  <div class="wrapper">
    <form class="form-signin" action="dlogin.php" method="post">       
      ...
      <br>
      <button class="btn btn-lg btn-block" type="submit" id="dlogin" name="dlogin" style="background-color: #BB9CC0; color: white">Login</button> <br>
                <p>if you don't have an account <a href="dregister.php" style="color: #BB9CC0;"> Click Here</a></p>
